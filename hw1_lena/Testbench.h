...
public:
  sc_in_clk i_clk;
  sc_out<bool> o_rst;
  std::array<std::array<sc_fifo_out<unsigned char>, MASK_Y>, MASK_X> o_r;
  std::array<std::array<sc_fifo_out<unsigned char>, MASK_Y>, MASK_X> o_g;
  std::array<std::array<sc_fifo_out<unsigned char>, MASK_Y>, MASK_X> o_b;
